...
// interproscan6 settings
params.ips6_version     = "6.0.0"    // ebi-pf-team/interproscan6 release tag
params.ips6_datadir     = "/bigdata/stajichlab/shared/lib/interproscan6_data"
params.ips6_interpro    = "latest"   // pin to e.g. "107.0" for reproducibility
params.ips6_goterms     = true
params.ips6_pathways    = true
params.ips6_applications = ""        // comma-separated; empty = all non-ML defaults

// Singularity image cache shared across all nodes
params.singularity_cache = "/bigdata/stajichlab/shared/containers/interproscan6"

// interproscan6 requires Nextflow ≥ 25.04.6; run `nextflow pull ebi-pf-team/interproscan6
// -r <ips6_version>` once on the head node so compute nodes can run with NXF_OFFLINE=true.
